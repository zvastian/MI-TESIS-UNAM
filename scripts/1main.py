...
def serve_index():
    ...
    return {"ok": True, "message": "FastAPI running, but static/graph_sigma.html was not found."}
...
def serve_graph():
    ...
    if graph_path.exists():
        return FileResponse(str(graph_path))
    return {"ok": False, "error": "static/graph_sigma.html not found"}
...
def serve_nobel_map():
    ...
    return {"ok": False, "error": "static/nobel_map.html not found"}
